...
import { Check } from '@/libs/rnr/icons/Check';
import { ChevronDown } from '@/libs/rnr/icons/ChevronDown';
import { ChevronRight } from '@/libs/rnr/icons/ChevronRight';
import { ChevronUp } from '@/libs/rnr/icons/ChevronUp';
import { cn } from '@/libs/rnr/utils';
import { TextClassContext } from '@/components/rnr/ui/text';
  ...
  return (
    <ContextMenuPrimitive.Portal hostName={portalHost}>
      <ContextMenuPrimitive.Overlay
        style={
          overlayStyle
            ? StyleSheet.flatten([{ position: 'absolute' }, overlayStyle])
            : Platform.OS !== 'web'
